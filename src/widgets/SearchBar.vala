  ...
  public class SearchBar : Gtk.Revealer {
    ...
    public void search_previous () {
      ...
      if (text_buffer != null) {
        ...
        if (!editor.search_for_iter_backward (start_iter, out end_iter)) {
          text_buffer.get_end_iter (out start_iter);
          editor.search_for_iter_backward (start_iter, out end_iter);
        }
      }
    }
    ...
    public bool search () {
      ...
      editor.search_context.settings.case_sensitive = case_sensitive;
